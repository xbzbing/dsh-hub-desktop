...
const NON_RENDERER_COPY_DEBT_USER_VISIBLE: readonly DebtEntry[] = [
  ...
  debt('src/main/local-runtime/local-runtime.ts', 'detail: `准备 dsh ${version} 运行时（首次需要安装，可能较慢）`'),
  ...
  debt('src/main/local-runtime/local-runtime.ts', "emit(id, 'starting', { detail: '解析运行时版本' })"),
